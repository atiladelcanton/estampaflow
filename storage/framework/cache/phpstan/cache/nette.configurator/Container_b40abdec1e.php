...
class Container_b40abdec1e extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0126(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/var/www/html',
			'/var/www/html/storage/framework/cache/phpstan',
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/var/www/html/storage/framework/cache/phpstan/resultCache.php');
	}
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_b40abdec1e $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/html/storage/framework/cache/phpstan/resultCache.php',
	...
	{
		return new Larastan\Larastan\Properties\MigrationCache('/var/www/html/storage/framework/cache/phpstan', false);
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/html/storage/framework/cache/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_b40abdec1e
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'resultCachePath' => '/var/www/html/storage/framework/cache/phpstan/resultCache.php',
			...
			'tmpDir' => '/var/www/html/storage/framework/cache/phpstan',
			'checkMissingIterableValueType' => false,
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/var/www/html/storage/framework/cache/phpstan',
