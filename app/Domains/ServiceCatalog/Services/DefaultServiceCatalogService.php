    ...
    private function definitions(): array
    {
        return [
            ...
            [
                ...
                'order' => 20,
                'parameters' => [
                    $this->parameter('screen_colors', 'Quantidade de cores', ServiceParameterFieldType::INTEGER, 'cores', true, true, 10),
                    $this->select(
                        'ink_system',
                        'Sistema de tinta',
                    ...
                    $this->parameter('width_cm', 'Largura da estampa', ServiceParameterFieldType::DECIMAL, 'cm', true, true, 40),
                    $this->parameter('height_cm', 'Altura da estampa', ServiceParameterFieldType::DECIMAL, 'cm', true, true, 50),
                    $this->select(
                        'white_base',
                        'Base branca',
                        ['Automático', 'Sim', 'Não'],
                    ...
                    $this->parameter('technical_notes', 'Observação técnica', ServiceParameterFieldType::TEXT, null, false, false, 70),
                ],
            ],
            [
                'code' => 'SUBLIMACAO',
