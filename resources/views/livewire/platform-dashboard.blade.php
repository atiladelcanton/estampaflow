<div class="page-shell">
    ...
    <section class="mt-8 table-shell overflow-x-auto">
        ...
        <table class="data-table">
            <thead><tr><th>Estamparia</th><th>Domínio</th><th>Membros</th><th>Trial</th><th>Status</th></tr></thead>
            <tbody>
                ...
                @empty
                    <tr><td colspan="5" class="py-12 text-center text-sm text-ink-400">Nenhuma estamparia cadastrada.</td></tr>
                @endforelse
            </tbody>
        </table>
    </section>
